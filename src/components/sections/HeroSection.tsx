...
import { HERO_IMAGES } from '@/lib/utils'

const HERO_IMAGE = HERO_IMAGES.main.local || HERO_IMAGES.main.fallback
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          An intimate Korean dining experience where each dish carries
          the spirit of Seoul — brought to life in the heart of Pune.
        </motion.p>
        ...
        >
          {[
            { value: '50+', label: 'Menu Items', korean: '메뉴' },
            { value: '200+', label: 'Happy Guests', korean: '고객' },
            { value: '4.9★', label: 'Rating', korean: '평점' },
          ].map((stat) => (
