...
const INTERIOR = {
  ...
  fallback: 'https://images.unsplash.com/photo-1514190051997-0f6f39ca5cde?w=1200&q=85',
}
      ...
      <div ref={formRef} className="px-6 lg:px-16 xl:px-24 max-w-[1400px] mx-auto pb-24 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-start">
            ...
            {!submitted ? (
              ...
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <InputField label="Phone" value={form.phone} onChange={set('phone')} type="tel" placeholder="+91 98765 43210" required />
                  </div>
                  <div className="mt-4">
              ...
              >
                ...
                <p className="text-xs text-charcoal-400" style={{ fontFamily: 'var(--font-outfit)', fontWeight: 300 }}>
                  ...
                  <a href="tel:+919876543210" className="text-korean-red no-underline hover:underline">+91 98765 43210</a>
                </p>
              </motion.div>
            )}
          </AnimatePresence>
        ...
        >
          ...
          <div className="relative h-72 lg:h-96 overflow-hidden" style={{ borderRadius: '2px' }}>
            <Image
              src={INTERIOR.local || INTERIOR.fallback}
          ...
          >
            <div>
              ...
              <p className="text-sm text-charcoal-600 leading-relaxed" style={{ fontFamily: 'var(--font-outfit)', fontWeight: 300 }}>
                Lane 7, Koregaon Park<br />Pune, Maharashtra 411001
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-1">
                {[['Mon–Fri', '12:00 PM – 10:00 PM'], ['Sat–Sun', '11:00 AM – 11:00 PM']].map(([d, h]) => (
                  <div key={d} className="flex justify-between">
                    <span className="text-sm text-charcoal-500" style={{ fontFamily: 'var(--font-outfit)', fontWeight: 300 }}>{d}</span>
                    <span className="text-sm text-charcoal-600" style={{ fontFamily: 'var(--font-outfit)', fontWeight: 400 }}>{h}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-3">
              <a href="tel:+919876543210" className="flex items-center gap-3 text-sm text-charcoal-600 hover:text-korean-red transition-colors duration-300 no-underline" style={{ fontFamily: 'var(--font-outfit)', fontWeight: 300 }}>
                <Phone size={13} className="text-korean-red" />
                +91 98765 43210
              </a>
              <a href="mailto:hello@gangnamkitchen.in" className="flex items-center gap-3 text-sm text-charcoal-600 hover:text-korean-red transition-colors duration-300 no-underline" style={{ fontFamily: 'var(--font-outfit)', fontWeight: 300 }}>
                <Mail size={13} className="text-korean-red" />
                hello@gangnamkitchen.in
              </a>
            </div>
          </div>
