...
const dishes = [
  {
    ...
    koreanName: '치킨',
    description: 'Double-fried to shattering crispness, glazed in our house gochujang sauce. A textural revelation.',
    price: '₹520',
  ...
  },
  {
    ...
    name: 'Bibimbap',
    koreanName: '비빔밥',
    description: 'Stone-bowl rice crowned with seasonal vegetables, a soft egg, and house-made gochujang.',
    price: '₹440',
  ...
  },
  {
    ...
    name: 'Tteokbokki',
    koreanName: '떡볶이',
    description: 'Silken rice cakes simmered in a spiced scarlet broth — Seoul street food, perfected.',
    price: '₹360',
    tags: ['Vegan'],
    size: 'small',
  },
  {
    ...
    name: 'Korean BBQ',
    koreanName: '바베큐',
    description: 'Premium cuts marinated overnight in soy, sesame and Korean pear. Grilled tableside.',
    price: '₹980',
  ...
  },
  {
    ...
    name: 'Korean Ramen',
    koreanName: '라면',
    description: 'Slow-simmered pork bone broth, silky noodles, a marinated egg, and house kimchi.',
    price: '₹480',
    tags: ['Comfort'],
    size: 'small',
  },
  {
    ...
    koreanName: '김치볶음밥',
    description: 'Three-day fermented kimchi wok-fried into butter rice, topped with a crispy egg.',
    price: '₹380',
    tags: ['Vegetarian'],
    size: 'small',
  },
  {
    ...
    koreanName: '핫도그',
    description: 'Mozzarella-stuffed, panko-rolled, drizzled in sugar and sauce. Seoul in one bite.',
    price: '₹280',
    tags: ['Street Food'],
    size: 'small',
  },
  {
    ...
    name: 'Bingsu',
    koreanName: '빙수',
    description: 'Shaved milk ice dusted with house red bean paste, condensed milk, and seasonal toppings.',
    price: '₹320',
    tags: ['Dessert'],
    size: 'small',
  },
