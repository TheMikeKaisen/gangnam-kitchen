...
const quickInfo = [
  {
    icon: MapPin,
    label: 'Location',
    value: 'Lane 7, Koregaon Park',
    sub: 'Pune, Maharashtra 411001',
  },
  {
    icon: Clock,
    label: 'Hours',
    value: 'Mon–Fri 12pm–10pm',
    sub: 'Sat–Sun 11am–11pm',
  },
  {
    icon: Phone,
    label: 'Reservations',
    value: '+91 98765 43210',
    sub: 'hello@gangnamkitchen.in',
  },
]
  ...
  return (
    ...
    >
      ...
      <motion.div className="absolute inset-0 z-0" style={{ y: imageY, scale: 1.1 }}>
        <Image
          src={INTERIOR_IMAGE.local || INTERIOR_IMAGE.fallback}
      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="uppercase font-medium tracking-widest">Call to Reserve</span>
          </a>
        </motion.div>
