...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: "As someone who lived in Seoul for two years, I was skeptical. Then I had the Ramen. The broth is the kind that takes all day — rich, layered, deeply comforting. They're not cutting corners here. Absolute gem of a restaurant.",
  ...
  },
  {
    ...
    location: 'Camp, Pune',
    rating: 5,
    text: "Most Korean restaurants in India play it safe. Gangnam Kitchen doesn't. The gochujang levels are authentic, the portions are generous, and the service is attentive without being intrusive. This is what Korean dining should feel like.",
